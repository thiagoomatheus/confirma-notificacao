...
const schema = z.object({
    ...
    data: z.optional(z.date().min(new Date(), "A data do lembrete precisa ser futura.")),
    ...
    dataEnvio: z.optional(z.date().min(new Date(), "A data de envio do lembrete precisa ser futura.")),
