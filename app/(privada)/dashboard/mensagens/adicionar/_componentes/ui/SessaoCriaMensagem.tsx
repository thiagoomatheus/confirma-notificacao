        ...
        <>
            ...
            <section className="flex flex-col lg:flex-row gap-8">
                <div className="flex flex-col gap-8 w-full">
                    ...
                    {mensagem && camposPreenchidos === totalDeCampos && (
                        <SessaoComBorda>
