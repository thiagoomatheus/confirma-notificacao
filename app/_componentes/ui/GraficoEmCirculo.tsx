...
const progressCircleVariants = tv({
  ...
  variants: {
    variant: {
      ...
      success: {
        background: "stroke-terciaria",
        circle: "stroke-primaria",
      },
    },
  },
  defaultVariants: {
...
const GraficoEmCirculo = React.forwardRef<SVGSVGElement, ProgressCircleProps>(
  (
    {
      value = 0,
      max = 100,
...
GraficoEmCirculo.displayName = "GraficoEmCirculo"

export { GraficoEmCirculo, type ProgressCircleProps }