...
const LinhaDeProgresso = React.forwardRef<HTMLDivElement, ProgressBarProps>(
  (
    {
      value = 0,
      max = 100,
...
LinhaDeProgresso.displayName = "LinhaDeProgresso"

export { LinhaDeProgresso, progressBarVariants, type ProgressBarProps }